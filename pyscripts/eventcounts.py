...
f_Det = h5py.File('dimuon_rv_Det.h5', 'r')
...
ax.text('L1',w_L1_astro+50, r'''$\epsilon_{Det \to L1} =$'''f'''{epsilon_astro_DetL1}''')
...
ax.text('L1',w_L1_atmos+1000, r'''$\epsilon_{Det \to L1} =$'''f'''{epsilon_atmos_DetL1}''',c='r')
ax.text('L2',w_L2_atmos+1000, r'''$\epsilon_{L1 \to L2} =$'''f'''{epsilon_atmos_L1L2}''',c='r')
ax.text('X',w_X_atmos+1000, r'''$\epsilon_{L2 \to X} =$'''f'''{epsilon_atmos_L2X}''',c='r')
